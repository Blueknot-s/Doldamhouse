          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className={`w-full flex justify-center py-4 px-4 border border-transparent rounded-sm shadow-sm text-sm font-bold text-white bg-black hover:bg-doldam-accent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition-all uppercase tracking-widest ${
